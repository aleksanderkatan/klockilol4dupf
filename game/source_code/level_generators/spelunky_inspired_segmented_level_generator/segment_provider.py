...
from source_code.level_generators.spelunky_inspired_segmented_level_generator.segment import segment
from source_code.logic.direction import get_cardinal
