...
from source_code.imports.all_speedruns import speedruns
from source_code.imports.log import log
from source_code.imports.platform_maze_passwords import passwords
from source_code.imports.save_state import level_statuses
from source_code.imports.view_constants import global_view_constants as v
from source_code.logic.modes.input.annoying_skip_response import get_annoying_response, status
from source_code.speedruns.settings import settings as speedrun_settings
...
def command_charmap(game_logic, commands):
    ...
    from source_code.imports.charmap import charmap as c
    def strip(s):
...
def command_spawn(game_logic, command):
    # has to be imported locally, this file is loaded before pygame is initialized
    from source_code.imports.charmap import charmap as c
    from source_code.logic.state_filler.option_maps import char_optionable_blocks, option_map
