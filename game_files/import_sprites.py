...
temp_sprites["block"] = pygame.image.load('sprites/blocks/0.bmp').convert()
temp_sprites["block_start"] = pygame.image.load('sprites/blocks/start.bmp').convert()
temp_sprites["block_end"] = pygame.image.load('sprites/blocks/end.bmp').convert()
temp_sprites["block_numeric_1"] = pygame.image.load('sprites/blocks/1.bmp').convert()
temp_sprites["block_numeric_2"] = pygame.image.load('sprites/blocks/2.bmp').convert()
temp_sprites["error"] = pygame.image.load('sprites/blocks/error.bmp').convert()
temp_sprites["block_ice"] = pygame.image.load('sprites/blocks/ice.bmp').convert()
temp_sprites["block_arrow_0"] = pygame.image.load('sprites/blocks/arrow.bmp').convert()
temp_sprites["block_arrow_1"] = pygame.image.load('sprites/blocks/arrow.bmp').convert()
temp_sprites["block_arrow_1"] = pygame.transform.rotate(temp_sprites["block_arrow_1"], 90)
temp_sprites["block_arrow_2"] = pygame.image.load('sprites/blocks/arrow.bmp').convert()
...
temp_sprites["block_numeric_5"] = pygame.image.load('sprites/blocks/5.bmp').convert()
