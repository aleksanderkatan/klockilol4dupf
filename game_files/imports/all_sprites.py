...
dimmer = pygame.image.load('game_files/sprites/blocks/black_block.bmp')
...
numeric_block_sprites["block_numeric_1"] = pygame.image.load('game_files/sprites/blocks/1.bmp').convert()
numeric_block_sprites["block_numeric_2"] = pygame.image.load('game_files/sprites/blocks/2.bmp').convert()
numeric_block_sprites["block_numeric_3"] = pygame.image.load('game_files/sprites/blocks/3.bmp').convert()
numeric_block_sprites["block_numeric_4"] = pygame.image.load('game_files/sprites/blocks/4.bmp').convert()
numeric_block_sprites["block_numeric_5"] = pygame.image.load('game_files/sprites/blocks/5.bmp').convert()
numeric_block_sprites["block_numeric_6"] = pygame.image.load('game_files/sprites/blocks/6.bmp').convert()
numeric_block_sprites["block_numeric_7"] = pygame.image.load('game_files/sprites/blocks/7.bmp').convert()
numeric_block_sprites["block_numeric_8"] = pygame.image.load('game_files/sprites/blocks/8.bmp').convert()
